...
knnClassifierFunction(train_images,test_images, train_labels, test_labels, class_names, 1)
knnClassifierFunction(train_images,test_images, train_labels, test_labels, class_names, 3)
nearestCenterClassifierFunction(train_images, train_labels, test_images, test_labels, class_names)